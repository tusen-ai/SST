...
echo ""
echo "Unpacking kitti data to tempdir."
echo ""
cd $TMPDIR/SST_$GPU_TYPE
mkdir data
source job_scripts/unpack_kitti.sh
echo ""
echo "Unpacking kitti data to tempdir is now done."
echo ""

echo ""
echo "Linking nuscenes data to tempdir."
echo ""
ln -s /mimer/NOBACKUP/groups/snic2021-7-127/eliassv/data/nuscenes $TMPDIR/SST_$GPU_TYPE/data/nuscenes
echo ""
echo "Linking nuscenes data to tempdir is now done."
echo ""
