...
def register_spconv2():
    ...
    try:
        from spconv.pytorch import (SparseConv2d, SparseConv3d, SparseConv4d,
                                    ...
                                    SparseConvTranspose3d, SparseConvTranspose4d, SparseInverseConv2d,
                                    SparseInverseConv3d, SparseInverseConv4d, SparseModule,
        ...
        CONV_LAYERS._register_module(
            SparseConvTranspose4d, 'SparseConvTranspose4d', force=True)
        ...
        CONV_LAYERS._register_module(
            SparseInverseConv4d, 'SparseInverseConv4d', force=True)
