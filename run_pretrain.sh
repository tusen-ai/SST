...
#bash tools/dist_test.sh configs/$DIR/$CONFIG.py ./$WORK/$CONFIG/epoch_24.pth 8 --options "jsonfile_prefix=./$WORK/$CONFIG/results_oldproj" --eval bbox
