...
train_pipeline = [
    dict(
        type='LoadPointsWithClassFromFile',
        coord_type='LIDAR',
        load_dim=6,
        use_dim=5,
        file_client_args=file_client_args,
    ...
    dict(
        type='LoadPointsWithClassFromPastFutureSweepsWaymo',
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'waymo_infos_train_futuresweeps.pkl',
            split='training',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'waymo_infos_val_futuresweeps.pkl',
        split='training',
