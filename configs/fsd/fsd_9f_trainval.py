...
data = dict(
    ...
    train=dict(
        ...
        times=1,
        dataset=dict(
            ann_file='./data/waymo/kitti_format/waymo_infos_trainval_futuresweeps.pkl',
            load_interval=1)
    ),
    test=dict(
        ann_file='./data/waymo/kitti_format/waymo_infos_test_futuresweeps.pkl',
        # ann_file='./data/waymo/kitti_format/waymo_infos_val_futuresweeps.pkl',
        split='testing'
    )
)
log_config=dict(
