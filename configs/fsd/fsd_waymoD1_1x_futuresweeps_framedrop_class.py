_base_ = [
    '../_base_/datasets/waymo-fsd-futuresweeps-framedrop-class.py',
...
custom_hooks = [
    dict(type='DisableAugmentationHook', num_last_epochs=1, skip_type_keys=('ObjectSample')),
