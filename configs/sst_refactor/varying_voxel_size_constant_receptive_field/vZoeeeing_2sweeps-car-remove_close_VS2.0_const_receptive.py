...
voxel_size = (2.0, 2.0, 8)
window_shape = (2, 2, 1)  # 2 * 2.0 = 4m
...
model = dict(
    ...
    middle_encoder=dict(
        ...
        sparse_shape=(50, 50, 1),  # tot_point_cloud_range / voxel_size (50+50)/2.0
        shuffle_voxels=True,
        debug=True,
        drop_info=drop_info,
    ...
    backbone=dict(
        ...
        output_shape=[50, 50],  # tot_point_cloud_range / voxel_size (50+50)/2.0
        num_attached_conv=3,
        conv_kwargs=[
