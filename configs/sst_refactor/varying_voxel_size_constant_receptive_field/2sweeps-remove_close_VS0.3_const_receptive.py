...
window_shape = (13, 13, 1)  # 13 * 0.3 = 3.9m
point_cloud_range = [-50.1, -50.1, -5, 50.1, 50.1, 3]
drop_info_training = {
...
model = dict(
    ...
    middle_encoder=dict(
        ...
        sparse_shape=(334, 334, 1),  # tot_point_cloud_range / voxel_size (50.1+50.1)/0.3
        shuffle_voxels=True,
        debug=True,
        drop_info=drop_info,
    ...
    backbone=dict(
        ...
        output_shape=[334, 334],   # tot_point_cloud_range / voxel_size (50.1+50.1)/0.3
        num_attached_conv=3,
        conv_kwargs=[
