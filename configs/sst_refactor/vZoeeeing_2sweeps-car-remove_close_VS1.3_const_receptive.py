...
voxel_size = (1.3, 1.3, 8)
window_shape = (3, 3, 1)  # 3 * 1.3 = 3.9m
...
model = dict(
    ...
    middle_encoder=dict(
        ...
        sparse_shape=(77, 77, 1),  # tot_point_cloud_range / voxel_size (50.05+50.05)/1.3
        shuffle_voxels=True,
        debug=True,
        drop_info=drop_info,
    ...
    backbone=dict(
        ...
        output_shape=[77, 77],  # tot_point_cloud_range / voxel_size (50.05+50.05)/1.3
        num_attached_conv=3,
        conv_kwargs=[
