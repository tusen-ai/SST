...
data = dict(
    ...
    test=dict(
        ...
        # tracklet_proposals_file='./data/waymo/kitti_format/fsd_pastfuture_vehicle_val_breaking01.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/tracklet_data/fsd_pastfuture_vehicle_maxtime10_val.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/tracklet_data/fsd_pastfuture_vehicle_maxtime10_ext_val.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/tracklet_data/fsd_pastfuture_vehicle_12tta_maxtime10_ext_test.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/tracklet_data/fsd_pastfuture_vehicle_maxtime10_ext_val_maxlen50.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/fsd_pastfuture_motion5_vehicle_val.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/tracklet_data/fsd_pastfuture_vehicle_test.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/tracklet_data/fsd_pastfuture_vehicle_12tta_val.pkl',
        # tracklet_proposals_file='./data/waymo/kitti_format/tracklet_data/fsd_pastfuture_vehicle_training.pkl',
